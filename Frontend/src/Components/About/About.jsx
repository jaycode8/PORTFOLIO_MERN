        ...
        <div className="aboutMe" id='aboutPage'>
            ...
            <div className="aboutText">
                <div>
                    <h3>About me</h3>
                    <p>
                        My name is James Mumo. I'm a freelancer based in Nairobi, Kenya and am passionate and
                        dedicated to my work. i have a strong foundation in JavaScript and Python.
                        Im ready to bussiness talks of any kind based on tech.
                    ...
                    <div className="buttons">
                        ...
                        <a href="resumeB.pdf" download='james_resume'>
                            <button>
                                Download cv
