        ...
        <div className="w-full grid place-items-center pt-12 pb-4 px-4" id="servicePage">
            ...
            <div className="w-full h-full mt-4 grid place-items-center justify-center grid-cols-services-grid gap-6 sm:gap-2 lg:gap-6 py-8 px-0 lg:px-40">
                {services.map((service, index) => (
                    <div className="group w-80 phones:w-full h-56 p-4 flex flex-col justify-center gap-12 rounded-lg text-white cursor-pointer transition duration-700 ease-out bg-[#171c22] hover:translate-y-[-0.8rem] sm:hover:translate-y-[-1rem] hover:bg-primary hover:text-[#121212]" key={index}>
